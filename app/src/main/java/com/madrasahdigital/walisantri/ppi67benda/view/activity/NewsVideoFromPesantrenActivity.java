...
public class NewsVideoFromPesantrenActivity extends AppCompatActivity {
    ...
    private final String TAG = NewsVideoFromPesantrenActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(ContextCompat
                    .getColor(NewsVideoFromPesantrenActivity.this, R.color.colorPrimaryDark));
        }

        aksibar = NewsVideoFromPesantrenActivity.this.getSupportActionBar();
        assert aksibar != null;
        aksibar.setDisplayHomeAsUpEnabled(true);

        sharedPrefManager = new SharedPrefManager(NewsVideoFromPesantrenActivity.this);
        initializeListener();
        new GetNews().execute();
    }
    ...
    private void initializationOfNewsViewer() {
        ...
        recyclerNewsHome = new RecyclerNewsHome(NewsVideoFromPesantrenActivity.this, newsModel.getPosts(), Constant.TYPE_NEWS_PAGE);
    ...
    private class GetNews extends AsyncTask<Void, Integer, Boolean> {
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            String url = Constant.LINK_GET_VIDEO_NEWS + "&page=" + page;
        ...
        protected void onPostExecute(Boolean isSuccess) {
            ...
            if (isSuccess) {
                ...
                UtilsManager.showToast(NewsVideoFromPesantrenActivity.this, getResources().getString(R.string.cekkoneksi));
            }
        }
    }
}
